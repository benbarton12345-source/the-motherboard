...
export const CATEGORY_RULES = [
  ...
  { category: 'Eating Out', keywords: ['UBER EATS', 'MENULOG', 'DOORDASH', 'PIZZA', 'BURGER', 'SUSHI', 'DUMBO GELATO', 'TACO', 'BAH MI', 'MILLER + BAKER', 'GOODS BAKERY', 'PRESTONS DELI', 'PRESTON', 'MALIBU SHAKES', 'FLOURISH', 'FROTH CRAFT', 'CHU', 'ALH GROUP', 'ALHGROUP', 'BETTYS', 'YATAI', 'PERTHY AND CO', 'MAESTRO', 'GALWAY', 'LAKES KITCHEN', 'LITTLE WAVE'] },
  { category: 'Transport', keywords: ['UBER TRIP', 'AMPOL', 'BP', 'CALTEX', 'SHELL', '7-ELEVEN', 'S24 BALCATTA'] },
  { category: 'Subscriptions', keywords: ['SPOTIFY', 'NETFLIX', 'APPLE.COM/BILL', 'DISNEY', 'AMAZON PRIME', 'YOUTUBE', 'AMAYSIM', 'OPTUS', 'TELSTRA', 'VODAFONE', 'AUSSIE BROADBAND', 'TPG', 'ANTHROPIC', 'UBER ONE', 'UBER *ONE'] },
  ...
  { category: 'Clothing & Retail', keywords: ['H&M', 'JD SPORTS', 'JD_AUSTRALIA', 'ZARA', 'COTTON ON', 'UNIQLO', 'MYER', 'DAVID JONES', 'BIG W', 'TARGET', 'KMART', 'IKEA', 'DUSK'] },
